...
export class BaseScene {
    constructor() {
        this._dimBlurMaterial = null;
        this._baseResolution = null;
    ...
    setBlur(amount) {
        if (this._dimBlurMaterial) {
            ...
            if (this._dimBlurMaterial.uniforms.u_resolution && this._baseResolution) {
                ...
                this._dimBlurMaterial.uniforms.u_resolution.value.set(this._baseResolution.x * scale, this._baseResolution.y * scale);
            }
        }
    }
}
