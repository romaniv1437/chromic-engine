...
import fragShader from '../shaders/obsidian_void_tunnel.frag';

/**
 * ObsidianVoidTunnelScene — Infinite fly-through tunnel of black glass
 * with gasoline-slick iridescence and birefringent light splitting.
 * Bass drives speed, treble drives chromatic refraction, beat shakes camera.
 */
export class ObsidianVoidTunnelScene extends BaseScene {
