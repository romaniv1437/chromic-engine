...
import fragShader from '../shaders/quantum_entropy.frag';

/**
 * QuantumEntropyScene — Volumetric probability density cloud visualizer.
 * RMS drives emission brightness, beat triggers orbital shifts.
 * Uses jittered step marching for high-performance volumetrics.
 */
export class QuantumEntropyScene extends BaseScene {
