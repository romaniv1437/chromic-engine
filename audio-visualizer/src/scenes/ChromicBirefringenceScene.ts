...
import fragShader from '../shaders/chromic_birefringence.frag';

/**
 * ChromicBirefringenceScene — Anisotropic crystal with dual-refraction optics.
 * Bass rotates the optical axis, treble drives chromatic split intensity.
 * Gasoline-slick thin-film iridescence on crystal surfaces.
 */
export class ChromicBirefringenceScene extends BaseScene {
