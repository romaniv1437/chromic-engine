...
import fragShader from '../shaders/chromic_glitch_vortex.frag';

/**
 * ChromicGlitchVortexScene — Digital entropy decay with time-desynchronized blocks.
 * Bass increases temporal desync between blocks, beat triggers spatial glitches.
 * Scanline and corruption overlays for aesthetic digital decay.
 */
export class ChromicGlitchVortexScene extends BaseScene {
