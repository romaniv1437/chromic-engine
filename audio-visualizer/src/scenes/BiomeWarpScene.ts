...
import fragShader from '../shaders/biome_warp.frag';

/**
 * BiomeWarpScene — 4-biome KIFS mutator with domain hashing, 4D hyperplane rotation,
 * boxFold Mandelbox architecture, Menger grids, crystalline shards, and skyscraper beams.
 * Anti-collision spiral path camera with spectral dispersion.
 */
export class BiomeWarpScene extends BaseScene {
