...
> **For businesses:** If you'd like to use Chromic Engine in a commercial setting, I offer flexible licensing arrangements. Reach out via [GitHub](https://github.com/romaniv1437) or email **illia@chromicengine.com** to discuss terms.
